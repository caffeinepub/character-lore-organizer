...
import { EditorPinGate } from "@/hooks/useEditorPin";
import type {
  Character,
  CharacterAbility,
                ...
                >
                  <DialogContent data-ocid="editor.delete.dialog">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        This cannot be undone. Type the character's exact name
                        to confirm deletion.
                      </DialogDescription>
                    </DialogHeader>
        ...
        <div className="max-w-3xl mx-auto px-6 py-8 space-y-10">
          ...
          <Section title="Basic Information">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <FormField label="Power Tier">
                <Select
                  value={form.powerTier ?? "Fledgling"}
                  onValueChange={(v) =>
                    set("powerTier", v as typeof form.powerTier)
                  }
                >
                  <SelectTrigger data-ocid="editor.powertier.select">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
          ...
          <Section title="Profile Appearance">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <FormField
                label={`Title Font Size: ${form.titleFontSize ?? 32}px`}
              >
                <Slider
          ...
          <Section title="Abilities">
            <div className="space-y-3">
                ...
                >
                  <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <FormField label="Emoji">
                      <Input
                        data-ocid={`editor.abilities.emoji.input.${idx + 1}`}
                        value={ability.emoji}
                        onChange={(e) => {
                    ...
                    <FormField label="Name">
                      <Input
                        data-ocid={`editor.abilities.name.input.${idx + 1}`}
                        value={ability.name}
                        onChange={(e) => {
                          const updated = [...(form.abilities ?? [])];
                          updated[idx] = {
                    ...
                    <FormField label="Description">
                      <Input
                        data-ocid={`editor.abilities.desc.input.${idx + 1}`}
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      const updated = (form.abilities ?? []).filter(
                        (_, i) => i !== idx,
                      );
                      set("abilities", updated);
                    }}
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                data-ocid="editor.abilities.add.button"
                onClick={() => {
                  ...
                  set("abilities", [...(form.abilities ?? []), newAbility]);
                }}
                className="gap-1.5 text-xs uppercase tracking-wider border-dashed"
              >
                <Zap size={13} />
